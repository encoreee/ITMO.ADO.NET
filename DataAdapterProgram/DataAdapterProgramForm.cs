...
{
    public partial class DataAdapterProgramForm : Form
    {
        static SqlConnection NorthwindConnection =
            new SqlConnection(@"Data Source=WS-45\SQLEXPRESS;Initial Catalog=northwind;Integrated Security=True");
        ...
        public DataAdapterProgramForm()
        {
            InitializeComponent();
        }

        private void DataAdapterProgramForm_Load(object sender, EventArgs e)
        {
        ...
        {
            NorthwindDataset.EndInit(); var index = dataGridView1.CurrentRow.Index;
